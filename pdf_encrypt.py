...
for folders, subfolders, filenames in os.walk('.'):
    ...
    for filename in filenames:
        ...
        if filename.endswith('.pdf'):
            ...
            pdfFile_obj = open(path, 'rb')
            pdf_reader = PyPDF2.PdfFileReader(pdfFile_obj)
...
if encrypt_failed != []:
    print('The following files failed their encryption checks and were not deleted :')
