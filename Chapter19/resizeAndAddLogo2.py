...
logo_im_resize = logo_im.resize((50,50))
logo_width, logo_height = logo_im_resize.size
...
for filename in os.listdir('.'):
    ...
    if width < logo_width * 2  or height < logo_height * 2:
        ...
        im.paste(logo_im_resize, (width - logo_width, height - logo_height), logo_im_resize)
